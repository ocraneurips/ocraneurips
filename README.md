...
To train on task 1 with 500 training samples run `python train_ocra_svrt.py --batch_size 32 --learning_rate 4e-5 --num_epochs 2000  --img_size 128  --configuration 'results_problem_1' --run '1'`
...
To train on task 1 with 1000 training samples run `python train_ocra_svrt.py --batch_size 32 --learning_rate 4e-5 --num_epochs 2000 --n 500  --img_size 128  --configuration 'results_problem_1' --run '1' --model_name 'slot_attention_augmentations_first_more_pretrained_svrt_1000_images_alltasks_frozen_autoencoder_ocra'`
